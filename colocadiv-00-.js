...
function init() {
		...
		for ( i=0, ii=mixedColors.length; i<ii; i++){
           for (j=0; j<mixedColors[i].length; j++) { 
           
			   var  div = document.createElement(x);
			   div.setAttribute("id", j);
			   div.setAttribute("class", "bloque");            
               div.setAttribute("style", "background-Color: " + rgbHex(mixedColors[i][j]));
               //debugger;
			   document.body.appendChild(div);
            }
            var c = document.createElement("br");
            if (i<ii) { document.body.appendChild(c); }  
		}
	}
